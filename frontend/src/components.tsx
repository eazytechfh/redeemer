...
export function Layout(){
  ...
  return <div className="app"><aside className={open?"sidebar open":"sidebar"}>
    <div className="brand">{branding?.logoUrl?<img className="brand-logo" src={branding.logoUrl} alt="Logo"/>:<span className="brand-icon"><GraduationCap/></span>}<div><b>EduClick</b><small>CRM EDUCACIONAL</small></div><button className="mobile-close" onClick={()=>setOpen(false)}><X/></button></div>
